import RoboticCenter1 from "/src/assets/Robotic1.jpg";
import RoboticCenter2 from "/src/assets/Robotic2.jpg";
...
<div id="default-carousel" className="relative mt-4 px-32" data-carousel="slide">
    <div className="relative overflow-hidden md:h-[32rem] rounded-xl" >
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
            ...
            <img src={RoboticCenter1} className="absolute h-[32rem] block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
        </div>
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <img src={RoboticCenter2} className="absolute h-[32rem] block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
        </div>
    </div>
