import BankImg from "/src/assets/BankImg.png";
import PostOffImg from "/src/assets/PostOffice.jpeg";
...
function Slider7(){
    ...
    <div id="default-carousel" className="relative mt-4 px-32" data-carousel="slide">
            <div className="relative overflow-hidden md:h-[32rem] rounded-xl" >
                ...
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src={PostOffImg} className="absolute h-[32rem] block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
                </div>
            </div>
